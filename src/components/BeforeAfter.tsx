...
const BEFORE_IMG = "https://cdn.poehali.dev/projects/650ff3e9-e7d6-4a0f-935f-7fcb054f7123/files/05ea1f43-2bd4-44ee-b4ed-29d405940c73.jpg"
const AFTER_IMG = "https://cdn.poehali.dev/projects/650ff3e9-e7d6-4a0f-935f-7fcb054f7123/files/ea7fc03b-449f-42ac-b664-8126a1dc944f.jpg"
  ...
  return (
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div
          ref={containerRef}
          className="relative w-full max-w-2xl mx-auto rounded-2xl overflow-hidden cursor-ew-resize select-none"
        ...
        >
          ...
          {/* После (чистая) — обрезается слева по ползунку */}
          <div
