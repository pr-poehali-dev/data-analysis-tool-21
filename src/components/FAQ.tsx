...
const faqs = [
  {
    ...
    answer:
      "Пришлите нам фото помещения и комментарий о его состоянии в наш аккаунт ВКонтакте. Мы рассчитаем точную стоимость и согласуем удобное время.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Абсолютно. Мы используем только сертифицированные средства, безвредные для здоровья людей и животных. После уборки можно сразу находиться в помещении.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Напишите нам ВКонтакте vk.com/kliningkostroma — пришлите фото помещения, укажите желаемую дату и вид уборки. Ответим в течение нескольких минут.",
  },
]
