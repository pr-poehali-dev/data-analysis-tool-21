...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Цена фиксируется до начала работы. Вы заранее знаете итоговую сумму — никаких сюрпризов после уборки.",
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-6 lg:pt-48">
            <p className="text-muted-foreground text-lg leading-relaxed max-w-md mb-12">
              Мы наводим порядок в десятках помещений каждый месяц. Доверяйте профессионалам — и наслаждайтесь результатом.
            </p>
